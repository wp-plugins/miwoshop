...
class ControllerSaleAffiliate extends Controller { 
	...
	public function approve() {
  	...
  	protected function getList() {
		...
		$pagination->url = $this->url->link('sale/affiliate', 'token=' . $this->session->data['token'] . $url . '&pg={page}', 'SSL');
	...
	public function transaction() {
		...
		$pagination->limit = $this->config->get('config_admin_limit');
		$pagination->text = $this->language->get('text_pagination');
		$pagination->url = $this->url->link('sale/affiliate/transaction', 'token=' . $this->session->data['token'] . '&affiliate_id=' . $this->request->get['affiliate_id'] . '&pg={page}', 'SSL');
