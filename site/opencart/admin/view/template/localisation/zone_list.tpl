        ...
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="right"><?php  if(!empty($zone['status'])) { echo $text_enabled; } else { echo $text_disabled;} ?></td>
...
function changeStatus(status){
    $.ajax({
        url: 'index.php?route=common/edit/changestatus&type=zone&status='+ status +'&token=<?php echo $token; ?>',
        dataType: 'json',
        data: $("#form").serialize(),
