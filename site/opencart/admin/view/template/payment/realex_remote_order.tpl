    ...
    <td id="capture_status">
      ...
      <?php } else { ?>
        ...
        <?php if ($realex_order['void_status'] == 0) { ?>
          ...
          <a class="button btn button-primary" id="btn_capture"><?php echo $btn_capture; ?></a>
          <span class="button button-primary" id="img_loading_capture" style="display:none;"><i class="fa fa-cog fa-spin fa-lg"></i></span>
        <?php } ?>
      <?php } ?>
    </td>
  </tr>
