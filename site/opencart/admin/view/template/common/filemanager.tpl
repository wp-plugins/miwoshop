...
<script type="text/javascript" src="<?php echo MURL_WP_CNT; ?>/miwi/media/jui/js/jquery-ui-1.10.4.custom.min.js"></script>
<script type="text/javascript" src="<?php echo MURL_WP_CNT; ?>/miwi/plugins/plg_miwoshop_js/js/ui/external/jquery.bgiframe-2.1.2.js"></script>
<script type="text/javascript" src="<?php echo MURL_WP_CNT; ?>/miwi/plugins/plg_miwoshop_js/js/jstree/jquery.tree.min.js"></script>
<script type="text/javascript" src="<?php echo MURL_WP_CNT; ?>/miwi/plugins/plg_miwoshop_js/js/ajaxupload.js"></script>
