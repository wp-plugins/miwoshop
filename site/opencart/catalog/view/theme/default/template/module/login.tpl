...
<div class="box_oc">
  ...
  <div class="box-content">
    ...
    <br /><br />
<div style="float:left; text-align: right;"><a onclick="jQuery('#module_login').submit();" class="<?php echo MiwoShop::getButton(); ?>"><span><?php echo $button_login; ?></span></a>&nbsp;</div>
    <div style="float:left; text-align: right;"><a href="<?php echo $this->url->link('account/register', '', 'SSL');?>" class="<?php echo MiwoShop::getButton(); ?>"><span><?php echo $button_create; ?></span></a></div>
    <br style="clear:both;"/>
    </form>
  </div>
 </div>
  ...
  <div class="box-content">
	  <div class="middle" id="information" style="text-align: left;">
		...
		<div style="text-align: center;border-top:1px solid #ccc;padding: 15px 0;">
			<a href="<?php echo $this->url->link('account/logout', '', 'SSL');?>" class="<?php echo MiwoShop::getButton(); ?>"><span><?php echo $button_logout; ?></span></a>
		</div>
	</div>
</div>
<?php } ?>