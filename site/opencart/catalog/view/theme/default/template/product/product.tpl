...
<div id="content"><?php echo $content_top; ?>
  ...
  <div id="tabs" class="htabs"><a href="#tab-description"><?php echo $tab_description; ?></a>
    ...
    <?php } ?>
    <?php if (MiwoShop::get('base')->getConfig()->get('comments', '0') != '0') { ?>
  ...
  <div id="tab-description" class="tab-content"><?php echo MiwoShop::get('base')->triggerContentPlg($description); ?></div>
  <?php if ($attribute_groups) { ?>
  ...
  <div id="tab-comments" class="tab-content">
      <?php
		$_jcomments = MiwoShop::getClass('base')->getConfig()->get('comments', '0');

		$jcomments = MPATH_SITE . '/components/com_jcomments/jcomments.php';
		$komento = MPATH_SITE . '/components/com_komento/bootstrap.php';
		$jomcomment = MPATH_SITE . '/plugins/content/jom_comment_bot.php';

		if ($_jcomments == 'jcomments' && file_exists($jcomments)) {
			require_once($jcomments);
			echo JComments::showComments($product_id, 'com_miwoshop', $heading_title);
		}
		...
		if ($_jcomments == 'komento' && file_exists($komento)) {
			...
			MRequest::setVar('route', 'product/product');
			echo Komento::commentify('com_miwoshop', $p_object, $p_options);
		}

		if ($_jcomments == 'jomcomment' && file_exists($jomcomment)) {
			require_once($jomcomment);
			echo jomcomment($product_id, "com_miwoshop");
		}
      ?>
  </div>
  <?php } ?>
...
$('#button-cart').bind('click', function() {
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect'] && json['miwoevents']) {
