...
class ControllerPaymentSecureTradingWs extends Controller {
	...
	public function index() {
		...
		if ($order_info) {
			...
			$this->data['entry_cvv2'] = $this->language->get('entry_cvv2');

			$this->data['text_card_details'] = $this->language->get('text_card_details');
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/securetrading_ws.tpl')) {
                $this->template = $this->config->get('config_template') . '/template/payment/securetrading_ws.tpl';
            } else {
                $this->template = 'default/template/payment/securetrading_ws.tpl';
            }
