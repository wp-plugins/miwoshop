...
class ControllerPaymentRealex extends Controller {
	public function index() {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/realex.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/realex.tpl';
		} else {
			$this->template = 'default/template/payment/realex.tpl';
		}
		$this->render();
	}
	...
	public function notify() {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/realex_response.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/payment/realex_response.tpl';
		} else {
			$this->template = 'default/template/payment/realex_response.tpl';
		}
		$this->render();
