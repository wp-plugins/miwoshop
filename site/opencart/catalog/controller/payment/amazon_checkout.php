...
class ControllerPaymentAmazonCheckout extends Controller {
    public function address() {
        if ($this->config->get('amazon_checkout_mode') == 'sandbox') {
			$this->data['amazon_payment_js'] = 'sandbox/PaymentWidgets.js';
		} elseif ($this->config->get('amazon_checkout_mode') == 'live') {
			$this->data['amazon_payment_js'] = 'PaymentWidgets.js';
		}
        ...
        $this->data['status'] = $this->config->get('amazon_checkout_mode');
        $this->data['merchant_id'] = $this->config->get('amazon_checkout_merchant_id');
        $this->data['amazon_payment'] = $this->url->link('payment/amazon_checkout/payment', 'format=raw&tmpl=component', 'SSL');
        $this->data['shipping_quotes'] = $this->url->link('payment/amazon_checkout/shipping_quotes', 'format=raw&tmpl=component', 'SSL');
    ...
    public function confirm() {        
        ...
        $customer_data = $this->db->query("SELECT * FROM " . DB_PREFIX . "customer WHERE customer_id = '" . (int)$this->customer->getId() . "'");
    ...
    public function process_order() {
        ...
        if ($amazon_order_ids) {
		 ...
		 $test =$this->config->get('amazon_checkout_order_default_status');
