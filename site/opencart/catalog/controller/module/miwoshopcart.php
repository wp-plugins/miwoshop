...
class ControllerModuleMiwoshopcart extends Controller { 
	protected function index() {
		...
		$this->id = 'miwoshopcart';
		
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/miwoshopcart.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/miwoshopcart.tpl';
		} else {
			$this->template = 'default/template/module/miwoshopcart.tpl';
		}
    ...
    public function ajax() {
        ...
        $output = MiwoShop::get('base')->replaceOutput($output, 'module');
